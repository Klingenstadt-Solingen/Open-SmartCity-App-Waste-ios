...
public enum OSCAWasteError: Swift.Error, CustomStringConvertible {
...
}// end public enum OSCAWasteError

extension OSCAWasteError: Equatable{
  public static func == (lhs: OSCAWasteError, rhs: OSCAWasteError) -> Bool {
    switch (lhs, rhs) {
...
}// end extension public enum OSCAWasteError
