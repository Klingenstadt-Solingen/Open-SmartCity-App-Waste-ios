...
let package = Package(
  ...
  targets: [
    ...
    .target(
      ...
      path: "OSCAWaste/OSCAWaste",
      exclude:["Info.plist",
               "SupportingFiles"],
      resources: [.process("Resources"),
                  .process("Objects/OSCAWasteCollectTests.json")]
    ),
    .testTarget(
      name: "OSCAWasteTests",
      dependencies: ["OSCAWaste",
                     .product(name: "OSCATestCaseExtension",
                              package: packageLocal ? "OSCATestCaseExtension" : "oscatestcaseextension-ios")],
      path: "OSCAWaste/OSCAWasteTests",
      exclude:["Info.plist"],
      resources: [.process("Resources"),
                  .process("Objects/OSCAWasteAddressTests.json"),
                  .process("search-.schema.json"),
                  .process("WasteAddress.schema.json")],
      swiftSettings: [
