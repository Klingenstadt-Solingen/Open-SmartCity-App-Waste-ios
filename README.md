<div style="display:flex;gap:1%;margin-bottom:20px">
  <h1 style="border:none">Open SmartCity Waste Module of the Open SmartCity App</h1>
...
* copy `Development.xcconfig` and `Production.xcconfig` to `OSCAWaste/OSCAWaste/SupportingFiles`, these files have to be ignored by git
